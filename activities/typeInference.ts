...
function greetUser(name, nickname) {
  if (nickname) {
...
const userAge = //use coalescing operator (??) here to print 30 on the next line
...
const defaultSettings = { //edit this
  theme: "dark"
};
...
//edit the console log to avoid erroring out
